...
def web_search(query: str, num_results: int = 5) -> str:
    ...
    Example usage in sandbox:
        # Search for AIDA marketing model
        results = web_search("AIDA marketing model components")
        print(results)

        # Search and parse
        info = web_search("What are the 4 tones of Mandarin Chinese?")
        # Analyze info and output answer
    """
